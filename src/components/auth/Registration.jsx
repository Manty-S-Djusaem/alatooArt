            ...
            <form className="modal-form" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div>
                    ...
                    <div className={module.icons}>
                        {/* <a href='#'> <img src={google} className={module.icon} alt='gmail' style={{
                            cursor: 'pointer'
                        }}></img> </a>
                        <a href='#'  id={module.one}> <img src={facebook} className={module.icon} alt='facebook' style={{
                            cursor: 'pointer'
                        }}></img> </a> */}
                    {/* </div> */}
                </div>
                <div className={module.signin}><p className={module.joinLink}> У вас уже есть аккаунт?<Link to='/shop-template/authorization'> Войти</Link></p></div>
                </div>
            </form>
        </div>
    )
